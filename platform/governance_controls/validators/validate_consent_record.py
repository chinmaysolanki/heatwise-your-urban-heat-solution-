...
_SCHEMA = _ROOT / "schemas" / "consent_record_schema.json"
...
def validate_consent_record(payload: dict[str, Any]) -> ValidationResult:
    v = _validator()
    ...
    if meta is not None and not isinstance(meta, dict):
        ...
        try:
            ...
            errs.append("metadata not JSON-serializable")
